...
- **Tack**: a boat is on the tack (starboard/port) corresponding to her windward side.
- **Leeward/Windward**: leeward side is the side away from the wind (or the side the
  mainsail lies on when head to wind or by the lee). When two same-tack boats overlap,
  the one on the other's leeward side is the leeward boat.
...
- **Proper course**: the course a boat would sail to sail the course as quickly as
  possible in the absence of the other boats referred to in the rule. **No proper
  course before her starting signal.** (New 2025 wording; urgent change Nov 2024.)
- **Fetching**: a boat is fetching a mark when she can pass to windward of it and leave
  it on the required side without changing tack.
- **Racing**: from her preparatory signal until she finishes and clears the finishing
  line and marks.

## Section A — Right of way

- **10 Opposite tacks**: port-tack boat keeps clear of starboard-tack boat. Applies on
  every point of sail, including downwind and at marks (right of way is separate from
  mark-room entitlement).
- **11 Same tack, overlapped**: windward boat keeps clear of leeward boat.
- **12 Same tack, not overlapped**: boat clear astern keeps clear of boat clear ahead.
- **13 While tacking**: after passing head to wind, a boat keeps clear of other boats
  until she is on a close-hauled course. (Changing tack downwind is a gybe — rule 13
  does not apply to gybing.)

## Section B — General limitations

- **14 Avoiding contact**: if reasonably possible, a boat shall (a) avoid contact with
  another boat, (b) not cause contact between boats, (c) not cause contact between a
  boat and an object that should be avoided. A right-of-way boat (or one sailing within
  room/mark-room she's entitled to) need not act until it is clear the other boat is
  not keeping clear / giving room. If she then breaks 14 without damage or injury, she
  is exonerated (43.1(c)).
- **15 Acquiring right of way**: a boat that acquires right of way shall initially give
  the other boat room to keep clear, unless she acquires it because of the other boat's
  actions.
...
- **17 Same tack; proper course**: if a boat clear astern becomes overlapped within two
  ...
  wind subject to 16.1.

## Section C — Marks and obstructions

Preamble: Section C rules (18, 19, 20) **do not apply** at a starting mark surrounded
by navigable water (or its anchor line) from the time boats are approaching it to start
until they have passed it. → "Barging": no mark-room at the committee boat; the
windward boat that squeezes in breaks rule 11 if the leeward boat must act.
...
- **19 Room to pass an obstruction** (applies when boats are "at" an obstruction, and
  not at a mark where 18 applies): 19.2(a) the ROW boat may choose which side to pass;
  if she changes course while choosing she must give room to keep clear (and is NOT
  exonerated for breaking this, unlike 16.1). 19.2(b) the outside boat gives the inside
  overlapped boat room between her and the obstruction, unless she has been unable to
  do so from the time the overlap began. At a **continuing** obstruction (shoreline,
  breakwater — never a boat racing or vessel under way): a keep-clear boat astern may
  not squeeze into a gap unless at the moment the overlap begins there is room to pass
  through. A right-of-way boat racing IS an obstruction to boats that must keep clear
  of her.
...
- **21 (2025 numbering; old 22)**: 21.1 a boat sailing toward the pre-start side of the
  ...
  clear.
- **31 Touching a mark**: while racing, don't touch a starting/course/finishing mark.
  Penalty: One-Turn. Exonerated if forced onto the mark by another boat's breach.
- **43.1 Exoneration (2025 numbering; old 21/64.1)**: a boat is exonerated when
  (a) compelled to break a rule by another boat's breach, (b) she breaks a rule of
...
1. Windward mark, opposite tacks on the beat: rule 18 OFF (18.1(a)(1)). Port on the
   layline entering the zone first gets nothing — rule 10 decides. (Q&A explicit.)
2. Leeward mark, opposite tacks downwind: overlap counts; inside port boat gets
   mark-room from outside starboard boat; starboard keeps right of way. Inside boat
   sailing within her mark-room is exonerated (43.1(b)) for breaking 10.
3. Zone-entry snapshot governs; late inside overlap ≠ mark-room; broken overlap ≠ lost
   mark-room; leaving the zone resets (18.2(b)); reasonable doubt → 18.2(e).
4. Tacking in the zone at the windward mark: 18.3 (see above); passing head to wind
   turns off any mark-room entitlement (18.2(b)) — a boat tacking around a leeward
   mark loses protection the instant she passes head to wind (then rule 13 governs).
5. Barging: Section C preamble kills mark-room at the start; L may luff to close the
   door subject to 16.1; after the gun L is capped at proper course only if rule 17
   applies to her (overlap gained from clear astern within 2 lengths).
6. An inside boat entitled to mark-room that is forced onto the mark by the outside
   boat's failure is exonerated for rule 31.
7. Mark-room ≠ right of way. Rule 18 never transfers right of way; it layers a room
   obligation on top. Score both concepts separately.
